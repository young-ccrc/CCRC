...
infiles=c("/srv/ccrc/data53/z5239661/awap/input/pre/1961-2010/rain.awap5.1981-2010.nc")

# list of variable names according to above file(s)
vars=c(prec="ppt_grid")

# output directory. Will be created if it does not exist.
outdir="/srv/ccrc/data53/z5239661/awap/dly/output/etccdi/base_1981-2010_5/"
