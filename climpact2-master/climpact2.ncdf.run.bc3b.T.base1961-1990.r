...
infiles=c("/srv/ccrc/data53/z5239661/bc3b/dly/TMAX2.bc3b.1981-2010.nc","/srv/ccrc/data53/z5239661/bc3b/dly/TMIN2.bc3b.1981-2010.nc")

# list of variable names according to above file(s)
vars=c(tmax="tmax",tmin="tmin")

# output directory. Will be created if it does not exist.
outdir="/srv/ccrc/data53/z5239661/bc3b/dly/output/etccdi/base_1961-1990_temperature/"
