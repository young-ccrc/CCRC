...
infiles=c("/srv/ccrc/data53/z5239661/csiro/dly/rain6.csiro.1981-2010.nc")

# list of variable names according to above file(s)
vars=c(prec="ppt_grid")

# output directory. Will be created if it does not exist.
outdir="/srv/ccrc/data53/z5239661/csiro/dly/output/etccdi/base_1981-2010_6/"

# Output filename format. Must use CMIP5 filename convention. i.e. "var_timeresolution_model_scenario_run_starttime-endtime.nc"
file.template="var_daily_csiro_d01_NA_1981-2010.nc"
...
thresholds.files=NULL#"thresholds.test.1990-2009.nc"
